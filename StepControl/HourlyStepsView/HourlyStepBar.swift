...
final class HourlyStepBar: UIView {
    ...
    init(data: BarData) {
        ...
        titleLabel.transform = CGAffineTransform(rotationAngle: -CGFloat.pi/4)
    ...
    func heightConstraints(data: BarData) -> Double {
        var height = 0.0
